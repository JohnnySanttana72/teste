      ...
      <hr>
        <div class="card-footer text-center">
            <p style="color: red; font-weight: bold">
                É recomendado que todas as imagens possuam a mesma dimensão.<br>
                Largura: Entre 1600px e 1900px.<br>
                Altura: 687px ou menor.<br>
  ...
  <div class="modal fade" id="modal-create" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form id="form1" method="POST" action="{{ route('admin.create_image_cover')}}" enctype="multipart/form-data">
          @csrf
          <div class="modal-body">
            <div class="ekko-lightbox-container" style="height: auto;">
              ...
              <div class="ekko-lightbox-item fade in show" id="image-cover">
                <img src="https://via.placeholder.com/5000x3000/FFFFFF?text=Selecione uma Banner" id="preview-image1" class="img-fluid" style="width: 75%;">
  ...
  <div class="modal fade" id="modal-edit" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form id="form2" method="POST" action="{{ route('admin.update_image_cover')}}" enctype="multipart/form-data">
          @csrf
          <div class="modal-body">
            <div class="ekko-lightbox-container" style="height: auto;">
              <div class="ekko-lightbox-item fade"></div>
  ...
  <script type="text/javascript">
    ...
    $('#modal-create').on('hidden.bs.modal', function () {
        ...
        $('#form1 img').each(function() {
           $(this).attr('src', 'https://via.placeholder.com/5000x3000/FFFFFF?text=Selecione um Banner'); 
        });
    });
