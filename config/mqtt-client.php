    ...
    */
    ...
    'connections' => [
        ...
        'default' => [
            ...
            'client_id' => env('MQTT_CLIENT_ID', 'NodeMCU'),
            ...
            'connection_settings' => [
                ...
                'tls' => [
                    ...
                    'ca_path' => env('MQTT_TLS_CA_PATH',  'C:/Users/Rafael/Documents/GitHub/Problema-2-SD/Web/certificates'),
                    'client_certificate_file' => env('MQTT_TLS_CLIENT_CERT_FILE', 'C:/Users/Rafael/Documents/GitHub/Problema-2-SD/Web/certificates/faebd263ac-certificate.pem.crt'),
                    'client_certificate_key_file' => env('MQTT_TLS_CLIENT_CERT_KEY_FILE', 'C:/Users/Rafael/Documents/GitHub/Problema-2-SD/Web/certificates/faebd263ac-private.pem.key'),
