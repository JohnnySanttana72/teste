        ...
        'default' => [
            ...
            'connection_settings' => [
                ...
                'tls' => [
                    ...
                    'ca_path' => env('MQTT_TLS_CA_PATH',   base_path()),
                    'client_certificate_file' => env('MQTT_TLS_CLIENT_CERT_FILE',  base_path().'/faebd263ac-certificate.pem.crt'),
                    'client_certificate_key_file' => env('MQTT_TLS_CLIENT_CERT_KEY_FILE',  base_path().'/faebd263ac-private.pem.key'),
