        ...
        'default' => [
            ...
            'connection_settings' => [
                ...
                'tls' => [
                    ...
                    'ca_path' => env('MQTT_TLS_CA_PATH',  'vendor/bin/heroku-app-apache2 certificates'),
                    'client_certificate_file' => env('MQTT_TLS_CLIENT_CERT_FILE', 'vendor/bin/heroku-app-apache2 certificates/faebd263ac-certificate.pem.crt'),
                    'client_certificate_key_file' => env('MQTT_TLS_CLIENT_CERT_KEY_FILE', 'vendor/bin/heroku-app-apache2 certificates/faebd263ac-private.pem.key'),
