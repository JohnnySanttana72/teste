        ...
        'default' => [
            ...
            'connection_settings' => [
                ...
                'tls' => [
                    ...
                    'client_certificate_file' => env('MQTT_TLS_CLIENT_CERT_FILE',  'faebd263ac-certificate.pem.crt'),
                    'client_certificate_key_file' => env('MQTT_TLS_CLIENT_CERT_KEY_FILE',  'faebd263ac-private.pem.key'),
